...
public class SudokuGa {
    ...
    private static int[] Sudoku_Lineal; //whole sudoku but in only one line
    public static void findSolution(QQWing s) throws Exception {
        ...
        conf.setPopulationSize(MAX_ALLOWED_POPULATION);
        Genotype population ;
    ...
    //converting each chromosone to a lineal array ( so that we can change the Sudoku )
